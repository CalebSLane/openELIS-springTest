...
import spring.mine.us.mn.state.health.lims.common.form.SampleBatchEntrySetupForm;
...
public class SampleBatchEntrySetupController extends BaseController {
  ...
  public ModelAndView showSampleBatchEntrySetup(HttpServletRequest request) {
    ...
    SampleBatchEntrySetupForm form = new SampleBatchEntrySetupForm();
    form.setFormName("sampleBatchEntrySetupForm");
    form.setFormAction("");
