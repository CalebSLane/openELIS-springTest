...
public class SamplePatientEntrySaveController extends BaseSampleEntryController {
	...
	PatientManagementInfo patientInfo = (PatientManagementInfo) PropertyUtils.getProperty(form, "patientProperties");
	...
	if ("success".equals(forward)) {
	    return new ModelAndView("forward:/SamplePatientEntry.do", "form", form);
