...
public abstract class LoginBaseAction extends Action implements IActionConstants {
    ...
    /**
     * Abstract method that sub classes must implement to perform the desired action
     */
	...
	try {
		...
		// actionName);
		// bugzilla 2154
		LogEvent.logInfo("LoginBaseAction", "setFormAttributes()",
			"LoginBaseAction formName = " + name + " actionName " + actionName);
	    }
